...
public class Send {
    public void mail(String recipient, String subject, String body) {
        try {
            final String username = "intelligent.medibuddy@gmail.com";
            final String password = "akashannutanvi@3";
            ...
            try {
                ...
                message.setFrom(new InternetAddress("intelligent.medibuddy@gmail.com"));
