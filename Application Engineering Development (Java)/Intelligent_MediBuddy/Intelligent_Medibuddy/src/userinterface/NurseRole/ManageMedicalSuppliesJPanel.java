...
import userinterface.MedicalDriveManagerRole.*;
...
public class ManageMedicalSuppliesJPanel extends javax.swing.JPanel {
     ...
     */
    public ManageMedicalSuppliesJPanel(JPanel userProcessContainer, UserAccountMedicalBooth account, Enterprise enterprise, EcoSystem business, MedicalBoothOrganization organization) {
        try {
            initComponents();
    ...
    private void populateMedicinesComboBox() {
        try {
            ...
            count++;
            Iterator it = organization.getMedicalSuppliesInMedicalBooth().getMedicalInventory().entrySet().iterator();
            while (it.hasNext()) {
    ...
    private void backJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backJButtonActionPerformed
        try {
            ...
            RequestToMedicalDriveManagerJPanel ccqjp = (RequestToMedicalDriveManagerJPanel) component;
    ...
    private void createNewMedicineButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createNewMedicineButtonActionPerformed
        try {
            ...
            if (!flag) {
                organization.getMedicalSuppliesInMedicalBooth().addToMedicalInventory(newMedicinesComboBox.getSelectedItem().toString(), 0);
