...
public class RequestAMedicalSupplierJPanel extends javax.swing.JPanel {
    ...
    public RequestAMedicalSupplierJPanel(JPanel userProcessContainer, UserAccountMedicalBooth account, Enterprise enterprise, EcoSystem business, MedicalBoothOrganization organization, String foodItemName) {
        try {
            initComponents();
