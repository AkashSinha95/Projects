...
public class RequestToDoctorJPanel extends javax.swing.JPanel {
     ...
     */
    public RequestToDoctorJPanel(JPanel userProcessContainer, UserAccountMedicalBooth account, Enterprise enterprise) {
        try {
            initComponents();
    ...
    private void requestTestJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_requestTestJButtonActionPerformed
        try {
            ...
            send.sms(message, "MediBuddy", phone);
    ...
    private void populateCategoryComboBox() {
        try {
            ...
            requestComboBox.addItem(MedicalBooths.RequestCategory.DoctorsNeeded.getValue());
//            requestComboBox.addItem(MedicalBooths.RequestCategory.MedicalSupplies.getValue());
            requestComboBox.addItem(MedicalBooths.RequestCategory.Beds.getValue());
        } catch (NullPointerException ex) {
            JOptionPane.showMessageDialog(null, "Null Pointer Exception Occurred!");
        } catch (ArrayIndexOutOfBoundsException ex) {
            JOptionPane.showMessageDialog(null, "Array Out of Bound Exception Occurred!");
