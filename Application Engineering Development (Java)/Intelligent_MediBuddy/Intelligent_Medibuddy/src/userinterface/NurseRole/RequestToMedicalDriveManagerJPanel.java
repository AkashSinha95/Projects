 ...
 * @author annubc
 */
public class RequestToMedicalDriveManagerJPanel extends javax.swing.JPanel {
     ...
     */
    public RequestToMedicalDriveManagerJPanel(JPanel userProcessContainer, UserAccountMedicalBooth account, Enterprise enterprise, EcoSystem business, MedicalBoothOrganization organization) {
        try {
            initComponents();
            Send send = new Send();
    ...
    private void initComponents() {
        ...
        medicinesCategoryComboBox = new javax.swing.JComboBox<>();
        ...
        enterpriseLabel.setText("Request your Medical Drive Manager");
    ...
    private void populateCategoryComboBox() {
        ...
        medicinesCategoryComboBox.addItem(MedicalBooths.RequestCategory.Beds.getValue());
//        medicinesCategoryComboBox.addItem(MedicalBooths.RequestCategory.MedicalSupplies.getValue());
        medicinesCategoryComboBox.addItem(MedicalBooths.RequestCategory.ApplyLeave.getValue());
    }
    ...
    private void requestTestJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_requestTestJButtonActionPerformed
        try {
            ...
            if (!message.isEmpty()) {
                ...
                NewRequestToMedicalDriveManager request = new NewRequestToMedicalDriveManager();
                ...
                for (Organization o : enterprise.getOrganizationDirectory().getOrganizationList()) {
                    for (UserAccount ua : o.getMedicalBoothUADirectory().getUserAccountList()) {
                        if (ua.getEmail() != null && ua.getRole() instanceof MedicalDriveManagerRole) {
                ...
                JOptionPane.showMessageDialog(null, "Request sent succesfully to Medical drive Manager");
            } else {
    ...
    private void saveAsPDFButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveAsPDFButtonActionPerformed
        ...
        String myFilepath = userAccount.getUsername() + "_RequestToMedicalDriveManager_" + pdfCount + ".pdf";
        try {
            PdfWriter.getInstance(newDocument, new FileOutputStream(userAccount.getUsername() + "_RequestToMedicalDriveManager_" + pdfCount + ".pdf"));
        } catch (DocumentException | FileNotFoundException ex) {
            Logger.getLogger(RequestToMedicalDriveManagerJPanel.class.getName()).log(Level.SEVERE, null, ex);
        }
        try {
            newDocument.open();
    ...
    private void medicinesCategoryComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_medicinesCategoryComboBoxActionPerformed
        if (medicinesCategoryComboBox.getItemCount() > 0) {
            if (medicinesCategoryComboBox.getSelectedItem().equals(MedicalBooths.RequestCategory.Beds.getValue())) {
            ...
            } else if (medicinesCategoryComboBox.getSelectedItem().equals(MedicalBooths.RequestCategory.ApplyLeave.getValue())) {
