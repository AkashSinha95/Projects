 ...
 * @author annubc
 */
public class ManageMedicalBoothsJPanel extends javax.swing.JPanel {
     ...
     */
    public ManageMedicalBoothsJPanel(JPanel userProcessContainer, OrganizationDirectory organizationDir, Enterprise enterprise) {
        try {
            initComponents();
            ...
            populateMedicalBoothRoleComboBox();
    ...
    public void populateMedicalBoothRoleComboBox() {
        try {
            medicalBoothRoleComboBox.removeAllItems();
            organizationDir.getOrganizationList().forEach((organization -> {
                if (organizationEmpJComboBox.getSelectedItem().equals(organization)) {
                    medicalBoothRoleComboBox.addItem(Role.RoleType.MedicalDriveManager.getValue());
                    medicalBoothRoleComboBox.addItem(Role.RoleType.Nurse.getValue());
                    medicalBoothRoleComboBox.addItem(Role.RoleType.Doctor.getValue());
                    medicalBoothRoleComboBox.addItem(Role.RoleType.Student.getValue());
                }
            }));
        } catch (NullPointerException ex) {
            JOptionPane.showMessageDialog(null, "Null Pointer Exception Occurred!");
    ...
    private void populateTable(Organization organization) {
        try {
            ...
            organization.getMedicalBoothDirectory().getMedicalBoothList().stream().map((medicalBooth) -> {
    ...
    private void initComponents() {
        ...
        jPanel1 = new javax.swing.JPanel(){public void paintComponent(Graphics g)
            ...
            medicalBoothRoleComboBox = new javax.swing.JComboBox<>();
            ...
            medicalBoothRoleComboBox.setBackground(new java.awt.Color(51, 153, 255));
            medicalBoothRoleComboBox.setFont(new java.awt.Font("Times New Roman", 0, 36)); // NOI18N
            medicalBoothRoleComboBox.setForeground(new java.awt.Color(102, 153, 255));
            medicalBoothRoleComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
            medicalBoothRoleComboBox.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent evt) {
                    medicalBoothRoleComboBoxActionPerformed(evt);
                }
            });
            jPanel1.add(medicalBoothRoleComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 440, 280, -1));
    ...
    private void createEmployeeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createEmployeeButtonActionPerformed
        ...
        String employeeName = nameJTextField.getText();
             if(employeeName == null || employeeName.equals("")){
                ...
                JOptionPane.showMessageDialog(null, "Please enter valid name for Employee");
                return;
            }
             else{
                 if(!employeeName.matches("^[a-zA-Z]+$")){
                     JOptionPane.showMessageDialog(null, "Please enter Employee Name as only a-z or A-Z");
                     return;
                 }
             }
        ...
        try {
            ...
            String roleType = medicalBoothRoleComboBox.getSelectedItem().toString();
            if (nameJTextField.getText().replaceAll(" ", "").length() == 0) {
                JOptionPane.showMessageDialog(null, "Name cannot be blank");
            } else {
                organization.getMedicalBoothDirectory().CreateMedicalBooth(name, roleType);
            }
    ...
    private void medicalBoothRoleComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_medicalBoothRoleComboBoxActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_medicalBoothRoleComboBoxActionPerformed
        ...
        try {
            ...
            if (selectedRow < 0) {
                ...
                if (selectionResult == JOptionPane.YES_OPTION) {
                    MedicalBooths s = (MedicalBooths) employeeJTable.getValueAt(selectedRow, 0);
                    Organization org = (Organization) organizationJComboBox.getSelectedItem();
                    for (MedicalBooths s1 : org.getMedicalBoothDirectory().getMedicalBoothList()) {
                        if (s1 == s) {
                            org.getMedicalBoothDirectory().removeMedicalBooth(s);
    ...
    private javax.swing.JComboBox<String> medicalBoothRoleComboBox;
