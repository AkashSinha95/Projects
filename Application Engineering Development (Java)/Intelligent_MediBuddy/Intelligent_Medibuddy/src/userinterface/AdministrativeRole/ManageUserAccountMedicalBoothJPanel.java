 ...
 * @author annubc
 */
public class ManageUserAccountMedicalBoothJPanel extends javax.swing.JPanel {

    /**
     * Creates new form ManageUserAccountMedicalBoothJPanel
     */
    private JPanel container;
    private Enterprise enterprise;
    private EcoSystem business;

    public ManageUserAccountMedicalBoothJPanel(JPanel container, Enterprise enterprise, EcoSystem business) {
        try{
            initComponents();
    ...
    public void populateEmployeeComboBox(Organization organization) {
        ...
        organization.getMedicalBoothDirectory().getMedicalBoothList().forEach((medicalBooth
        ) -> {
            employeeJComboBox.addItem(medicalBooth
            );
        });
        }
        catch(NullPointerException ex){
    ...
    private void populateRoleComboBox() {
        try{
            MedicalBooths s = (MedicalBooths) employeeJComboBox.getSelectedItem();
    ...
    public void popData() {
        ...
        enterprise.getOrganizationDirectory().getOrganizationList().forEach((organization) -> {
            organization.getMedicalBoothUADirectory().getUserAccountList().stream().map((ua) -> {
    ...
    private void createjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createjButtonActionPerformed
        ...
        String userName1 = nameJTextField.getText();
       ...
       if(contactNumber == null || contactNumber.equals("")){
                ...
                return;
                 ...
                 if(!contactNumber.matches("^(?=.*[0-9]).{10,10}")){
                     JOptionPane.showMessageDialog(null, "Please enter valid 10 digit Contact Number");
                     return;
                 }
             }
        ...
        MedicalBooths medicalBooth
                = (MedicalBooths) employeeJComboBox.getSelectedItem();
        ...
        if (email.replaceAll(" ", "").length() == 0 || userName.replaceAll(" ", "").length() == 0 || password.replaceAll(" ", "").length() == 0) {
            ...
            if (exist) {
                ...
                if (roleType.equals(Role.RoleType.MedicalDriveManager.getValue())) {
                    role = new MedicalDriveManagerRole();
                    organization.getMedicalBoothUADirectory().createUserAccount(userName, password, medicalBooth
                            , role, email, phone);
                    ...
                    organization.getMedicalBoothUADirectory().createUserAccount(userName, password, medicalBooth
                            , role, email, phone);
                } else if (roleType.equals(Role.RoleType.Student.getValue())) {
