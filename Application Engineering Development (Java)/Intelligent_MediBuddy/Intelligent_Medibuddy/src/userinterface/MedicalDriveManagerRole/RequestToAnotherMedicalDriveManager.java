 ...
 */
public class RequestToAnotherMedicalDriveManager extends javax.swing.JPanel {
     ...
     */
    public RequestToAnotherMedicalDriveManager(JPanel userProcessContainer, UserAccountMedicalBooth account, Enterprise enterprise, EcoSystem business, MedicalBoothOrganization organization) {
        try {
            initComponents();
    ...
    private void requestTestJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_requestTestJButtonActionPerformed
        try {
            ...
            NewRequestFromMedicalDriveManagerToMedicalDriveManager request = new NewRequestFromMedicalDriveManagerToMedicalDriveManager();
...
//                    org = organization;
            ...
            for (Organization org : orgList) {
                if (org != null) {
                    org.getRequestQueueMedicalDriveManagerMedicalDriveManager().getworkRequestMedicalDriveManagerMedicalDriveManager().add(request);
                }
            }
            userAccount.getRequestQueueMedicalDriveManagerMedicalDriveManager().getworkRequestMedicalDriveManagerMedicalDriveManager().add(request);
            String recepient = "";
    ...
    private void backJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backJButtonActionPerformed
        try {
            ...
            ccqjp.populateMedicalDriveManagerTable();
    ...
    private void populateCategoryComboBox() {
        ...
        requestComboBox.addItem(MedicalBooths.RequestCategory.SendingPatients.getValue());
    }

    private void populatePatientNameComboBox() {
        patientNameComboBox.removeAllItems();

        for (MedicalBooths s : organization.getMedicalBoothDirectory().getMedicalBoothList()) {
            if (s.getRoleType().equals(Role.RoleType.Student.getValue())) {
    ...
    private void saveAsPDFButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveAsPDFButtonActionPerformed
        ...
        String myFilepath = userAccount.getUsername() + "_RequestToAnotherMedicalDriveManager_" + pdfCount + ".pdf";
        try {
            PdfWriter.getInstance(newDocument, new FileOutputStream(myFilepath));
        } catch (DocumentException | FileNotFoundException ex) {
            Logger.getLogger(RequestToAnotherMedicalDriveManager.class.getName()).log(Level.SEVERE, null, ex);
        }
        try {
            newDocument.open();
            ...
            newDocument.add(new Paragraph("Your Request has been send to another Medical Drive Manager."));
            newDocument.add(new Paragraph(" "));
