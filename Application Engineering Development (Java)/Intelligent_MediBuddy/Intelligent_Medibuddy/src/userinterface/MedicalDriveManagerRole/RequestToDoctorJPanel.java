...
public class RequestToDoctorJPanel extends javax.swing.JPanel {
     ...
     */
    public RequestToDoctorJPanel(JPanel userProcessContainer, UserAccountMedicalBooth account, Enterprise enterprise, EcoSystem business) {
        try {
            initComponents();
...
//            Organization org = null;
            ...
            if (org != null) {
                org.getRequestQueueMedicalDriveManagerDoctor().getWorkRequestMedicalDriveManagerDoctor().add(request);
            }
            }
            
                userAccount.getRequestQueueMedicalDriveManagerDoctor().getWorkRequestMedicalDriveManagerDoctor().add(request);
            String recepient = "";
    ...
    private void populateCategoryComboBox() {
        ...
        requestComboBox.addItem(MedicalBooths.RequestCategory.MedicalSupplies.getValue());
        requestComboBox.addItem(MedicalBooths.RequestCategory.RelievingNurse.getValue());
    }
