...
public class ManageFoodSuppliesJPanel extends javax.swing.JPanel {
     ...
     */
    public ManageFoodSuppliesJPanel(JPanel userProcessContainer, UserAccountMedicalBooth account, Enterprise enterprise, EcoSystem business, MedicalBoothOrganization organization) {
        try {
            initComponents();
    ...
    private void initComponents() {
        ...
        newFoodItemComboBox = new javax.swing.JComboBox<>();
        ...
        foodItemsComboBox = new javax.swing.JComboBox<>();
    ...
    public void populateFoodItemsComboBox() {
        ...
        count++;
        Iterator it = organization.getFoodSuppliesInMedicalBooth().getFoodInventory().entrySet().iterator();
        while (it.hasNext()) {
    ...
    private void createNewFoodItemButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createNewFoodItemButtonActionPerformed
        try {
            ...
            if (!flag) {
                organization.getFoodSuppliesInMedicalBooth().addToFoodInventory(newFoodItemComboBox.getSelectedItem().toString(), 0);
