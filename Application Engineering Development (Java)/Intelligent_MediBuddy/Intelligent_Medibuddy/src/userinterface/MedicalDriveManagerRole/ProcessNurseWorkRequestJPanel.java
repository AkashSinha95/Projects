...
public class ProcessNurseWorkRequestJPanel extends javax.swing.JPanel {
    ...
    NewRequestToMedicalDriveManager request;

    /**
     * Creates new form ProcessWorkRequestJPanel
     */
    public ProcessNurseWorkRequestJPanel(JPanel userProcessContainer, NewRequestToMedicalDriveManager request) {
        try {
            initComponents();
    ...
    private void backJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backJButtonActionPerformed
        try {
            ...
            MedicalDriveManagerWorkAreaJPanel dwjp = (MedicalDriveManagerWorkAreaJPanel) component;
            dwjp.populateTable();
