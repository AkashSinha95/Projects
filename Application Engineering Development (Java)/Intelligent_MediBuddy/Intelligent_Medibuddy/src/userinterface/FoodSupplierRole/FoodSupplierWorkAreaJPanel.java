...
public class FoodSupplierWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public void populateTable() {
        ...
        for (WorkRequestMedicalDriveManagerFoodSupplier request : foodSupplierOrganization.getRequestQueueMedicalDriveManagerFoodSupplier().getWorkRequestMedicalDriveManagerFoodSupplier()) {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 330, 550, 310));
    ...
    private void assignJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_assignJButtonActionPerformed
        ...
        WorkRequestMedicalDriveManagerFoodSupplier request = (WorkRequestMedicalDriveManagerFoodSupplier) workRequestJTable.getValueAt(selectedRow, 0);
    ...
    private void processJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processJButtonActionPerformed
        ...
        }
        {
            if (!"Pending".equals(request.getStatus()) || !userAccount.getUsername().equals(request.getReceiver().getUsername())) {
                ...
                ProcessWorkRequestMedicalDriveManagerFoodSupplierJPanel processWorkRequestJPanel = new ProcessWorkRequestMedicalDriveManagerFoodSupplierJPanel(userProcessContainer, request, foodSupplierOrganization, business);
