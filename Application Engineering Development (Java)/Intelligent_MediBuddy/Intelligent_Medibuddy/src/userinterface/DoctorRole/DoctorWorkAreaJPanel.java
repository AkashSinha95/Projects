...
public class DoctorWorkAreaJPanel extends javax.swing.JPanel {
     ...
     */
    public DoctorWorkAreaJPanel(JPanel userProcessContainer, UserAccountMedicalBooth account, Organization organization, Enterprise enterprise, EcoSystem business) {
        try {
            initComponents();
    ...
    public void populateCampCommanderRequestTable() {
        ...
        for (WorkRequestMedicalDriveManagerDoctor request : medicalCamp.getRequestQueueMedicalDriveManagerDoctor().getWorkRequestMedicalDriveManagerDoctor()) {
    ...
    private void initComponents() {
        ...
        processCampCommanderJButton.setText("Process Medical Drive Manager requst");
        ...
        workRequestJTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Message", "Medical drive Manager", "Doctor", "Status"
            }
        ) {
        ...
        jLabel3.setText("MEDICAL DRIVE MANAGER REQUESTS IN YOUR QUEUE");
    ...
    private void assignJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_assignJButtonActionPerformed
        try {
            ...
            WorkRequestMedicalDriveManagerDoctor request = (WorkRequestMedicalDriveManagerDoctor) workRequestJTable.getValueAt(selectedRow, 0);
        ...
        try {
            ...
            }
            {
                if (!"Pending".equals(request.getStatus()) || !userAccount.getUsername().equals(request.getReceiver().getUsername())) {
                    ...
                    ProcessMedicalDriveManagerWorkRequestJPanel processWorkRequestJPanel = new ProcessMedicalDriveManagerWorkRequestJPanel(userProcessContainer, request);
