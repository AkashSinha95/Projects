...
public class CheckOrBookBedsPanel extends javax.swing.JPanel {
    ...
    static JLabel label1 = new JLabel("Location 1", JLabel.CENTER);
    static JLabel label2 = new JLabel("Location 2", JLabel.CENTER);
    static JLabel label3 = new JLabel("Location 3", JLabel.CENTER);
    static JLabel label4 = new JLabel("Location 4", JLabel.CENTER);
    static JLabel label5 = new JLabel("Location 5", JLabel.CENTER);
    static JLabel label6 = new JLabel("Location 6", JLabel.CENTER);
    static int count = 0;
    static int row, col, flag = 0;
    private static ArrayList<String> bedNos;
    private static String text1, rowName;
    
    public CheckOrBookBedsPanel(JPanel userProcessContainer, UserAccountMedicalBooth account, MedicalCampOrganization organization) {
        initComponents();
