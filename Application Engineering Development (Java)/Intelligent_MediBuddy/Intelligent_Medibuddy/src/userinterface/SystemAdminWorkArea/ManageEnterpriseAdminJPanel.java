...
public class ManageEnterpriseAdminJPanel extends javax.swing.JPanel {
    ...
    private void populateTable() {
        ...
        for (Network network : system.getNetworkList()) {
            for (Enterprise enterprise : network.getEnterpriseDirectory().getEnterpriseList()) {
                for (UserAccountMedicalBooth userAccount : enterprise.getMedicalBoothUADirectory().getUserAccountList()) {
    ...
    public void populateRoleComboBox() {
        ...
        if (count > 0) {
            for (Enterprise.EnterpriseType type : Enterprise.EnterpriseType.values()) {
                ...
                if (e.getEnterpriseType().toString().equals(type.Schools.getValue())) {
                    roleComboBox.addItem(Role.RoleType.MedicalDriveManager.getValue());
    ...
    private void initComponents() {
        ...
        jPanel1.add(emailJTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 510, 320, 50));
        ...
        jPanel1.add(emailLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 510, 150, 50));
        ...
        jPanel1.add(roleComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 360, 320, 50));
        ...
        jPanel1.add(emailLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 600, 150, 50));
        ...
        jPanel1.add(phoneJTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 600, 320, 50));
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
       ...
       String firstName = nameJTextField1.getText();
             if(firstName == null || firstName.equals("")){
                ...
                return;
                 ...
                 if(!firstName.matches("^[a-zA-Z]+$")){
                     JOptionPane.showMessageDialog(null, "Please enter Name as only a-z or A-Z");
                     return;
                 }
             }
       ...
       if(emailId == null || emailId.equals("")){
                ...
                return;
                 ...
                 if(!emailId.matches("^[a-zA-Z0-9]+[a-zA-Z0-9]+@[a-zA-Z0-9]+.[a-zA-Z0-9]+$")){
        ...
        if (name.replaceAll(" ", "").length() == 0 || username.replaceAll(" ", "").length() == 0 || password.replaceAll(" ", "").length() == 0) {
            ...
            for (Network n : system.getNetworkList()) {
                for (Enterprise e : n.getEnterpriseDirectory().getEnterpriseList()) {
                    for (UserAccount u : e.getMedicalBoothUADirectory().getUserAccountList()) {
            ...
            if (exist) {
                ...
                if (roleType.equals(Role.RoleType.MedicalDriveManager.getValue())) {
                    // something    
                    MedicalBooths medicalBooths = enterprise.getMedicalBoothDirectory().CreateMedicalBooth(name, roleType);
                    UserAccount account = enterprise.getMedicalBoothUADirectory().createUserAccount(username, password, medicalBooths, new AdminRole(), email, phone);
